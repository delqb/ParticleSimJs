...
import { PositionComponent, VelocityComponent, ParticleComponent } from "../../Components.js";
...
export class CollisionSystem extends System<CollisionSystemNode> {
    NODE_COMPONENT_KEYS: Set<keyof CollisionSystemNode> = new Set(['particle', 'position', 'velocity']);
    public updateNode(node: CollisionSystemNode, entityID: EntityID) {
        // const DELTA_TIME = engine.getDeltaTime();
        // let { position, velocity, particle } = node;
